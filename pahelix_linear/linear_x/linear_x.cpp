...
py::tuple LinearX::linear_partition_c(
        std::string& sequence,
        int beam_size,
        float bpp_cutoff,
        bool no_sharp_turn) {
...
py::tuple LinearX::linear_partition_v(
        std::string& sequence,
        int beam_size,
        float bpp_cutoff,
        bool no_sharp_turn) {
...
py::tuple LinearX::linear_fold_c(
        std::string& sequence,
        int beam_size,
...
py::tuple LinearX::linear_fold_v(
        std::string& sequence,
        int beam_size,
        bool use_constraints,
        const std::string& constraint,
...
bool LinearX::check_input(std::string& sequence) {
...
bool LinearX::check_input_references(
...
bool LinearX::check_input_constraints(
        const std::string& sequence,
...
PYBIND11_MODULE(linear_x, m) {
    py::class_<LinearX>(m, "LinearX")
        .def(py::init<>())
        .def("linear_partition_c",
                &LinearX::linear_partition_c,
                py::arg("sequence") = "",
                py::arg("beam_size") = 100,
                py::arg("bp_cutoff") = 0.0,
                py::arg("no_sharp_turn") = true,
                py::return_value_policy::reference)
        .def("linear_partition_v",
                &LinearX::linear_partition_v,
                py::arg("sequence") = "",
                py::arg("beam_size") = 100,
                py::arg("bp_cutoff") = 0.0,
                py::arg("no_sharp_turn") = true,
